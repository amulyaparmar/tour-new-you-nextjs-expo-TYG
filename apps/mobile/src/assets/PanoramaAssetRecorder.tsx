...
const styles = StyleSheet.create({
  ...
  expandedPreview: { ...StyleSheet.absoluteFillObject, zIndex: 30, overflow: "hidden", backgroundColor: "#000" },
  expandedPreviewLayer: { ...StyleSheet.absoluteFillObject },
  ...
  shotViewer: { ...StyleSheet.absoluteFillObject, zIndex: 20, backgroundColor: "#020617" },
  ...
  processingGrid: { ...StyleSheet.absoluteFillObject, opacity: 0.28 },
